        ...
        <div class="grid lg:grid-cols-2 gap-12 items-center">
          <div class="space-y-8">
            ...
            <div class="fade-in delay-3 flex flex-wrap gap-4">
              ...
              <a href="#contact" class="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white font-medium px-8 py-4 rounded-xl transition-all backdrop-blur-sm border border-white/20">
                Nous contacter
              </a>
            </div>
          </div>
